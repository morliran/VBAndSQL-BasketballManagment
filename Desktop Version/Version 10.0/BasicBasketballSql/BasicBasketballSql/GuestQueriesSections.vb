...
Public Class GuestQueriesSections
    ...
    Private ColorCol1 As String = "#", ColorCol2 As String = "#", ColorCol3 As String = "#", ColorCol4 As String = "#", FillColor As String = "", SectionChosen As String = ""
...
#Region "איוונטים בעת לחיצות על הכפתורים או התמונה של בחירת הצבע"
    ...
    Private Sub Btn_Save_Click(sender As Object, e As EventArgs) Handles Btn_Save.Click
        ...
        Using file As StreamWriter = New StreamWriter("GuestColors.txt", False) 'ברגע שיש false בכל פעם שהמשתמש ילחץ על לשמור את העיצוב מה שהיה מקודם בטקסט יעלם
            file.WriteLine(ColorCol1)
            file.WriteLine(ColorCol2)
            file.WriteLine(ColorCol3)
            file.WriteLine(ColorCol4)
        End Using
    ...
    Private Sub CheckBoxCheck_CheckedChanged(sender As Object, e As EventArgs) Handles CB_1.CheckedChanged, CB_2.CheckedChanged, CB_3.CheckedChanged, CB_4.CheckedChanged
        ...
        If MyCheck.Checked = True Then
            ...
            Select Case MyCheck.Name
                Case "CB_1"
                    ColorCol1 = ColorCol1 + Hex(Btn_Example.ForeColor.ToArgb()).Substring(2, 6)
                Case "CB_2"
                    ColorCol2 = ColorCol2 + Hex(Btn_Example.ForeColor.ToArgb()).Substring(2, 6)
                Case "CB_3"
                    ColorCol3 = ColorCol3 + Hex(Btn_Example.ForeColor.ToArgb()).Substring(2, 6)
                Case "CB_4"
                    ColorCol4 = ColorCol4 + Hex(Btn_Example.ForeColor.ToArgb()).Substring(2, 6)
            End Select
        Else
            CheckBoxClickCnt -= 1
            Select Case MyCheck.Name
