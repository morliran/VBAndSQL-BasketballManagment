            ...
            For Each n In TreeP.Nodes 'Removing the unnecessary leafs for admins, managers and guests, Tag 0 = admins, Tag 1 = managers, Tag 2 = guests
                If n.Nodes.Count > 0 Then
                    For Each nChild In n.Nodes
                        If FormTag = 0 Then
                            If nChild.Name = "Node_Admin" Then
                                If Accessibility.Language.Equals("Hebrew") Then
                                    nChild.Text = "עזרה"
                                Else
                                    nChild.Text = "Help"
                                End If
                            End If
                            If nChild.Name = "Node_Manager" Or nChild.Name = "Node_Guest" AndAlso nChild.Nodes.Count > 0 Then
                                nChild.Nodes.Clear()
                            End If
                        End If
                        If FormTag = 1 Then
                            If nChild.Name = "Node_Manager" Then
                                If Accessibility.Language.Equals("Hebrew") Then
                                    nChild.Text = "עזרה"
                                Else
                                    nChild.Text = "Help"
                                End If
                            End If
                            If nChild.Name = "Node_Admin" AndAlso nChild.Nodes.Count > 0 Then
                                nChild.Nodes.Clear()
                            End If
                        ElseIf FormTag = 2 Then
                            If nChild.Name = "Node_Guest" Then
                                If Accessibility.Language.Equals("Hebrew") Then
                                    nChild.Text = "עזרה"
                                Else
                                    nChild.Text = "Help"
                                End If
                            End If
                            If nChild.Name = "Node_Admin" Or nChild.Name = "Node_Manager" AndAlso nChild.Nodes.Count > 0 Then
                                nChild.Nodes.Clear()
                            End If
                        End If
                    Next
