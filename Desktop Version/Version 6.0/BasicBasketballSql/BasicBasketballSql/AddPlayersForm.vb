...
#Region "אופציות על הפורם"
    Private Sub AddPlayersForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        GB_PlayerD.Location = New Point((Me.Width - GB_PlayerD.Width) \ 2, (Me.Height - GB_PlayerD.Height) \ 2)
        'GB_PlayerD.BackColor = Color.FromArgb(75, Color.DarkGray)
        GB_PlayerD.BackColor = Color.FromArgb(75, ColorTranslator.FromHtml("#89ABE3"))
    ...
    Private Sub AddPlayersForm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        ...
        End If
    End Sub
    Private Sub AddPlayersForm_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
        GB_PlayerD.Location = New Point((Me.Width - GB_PlayerD.Width) \ 2, (Me.Height - GB_PlayerD.Height) \ 2)
    End Sub
#End Region
