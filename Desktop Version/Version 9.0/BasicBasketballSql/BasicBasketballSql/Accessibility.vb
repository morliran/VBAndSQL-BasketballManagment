...
Public NotInheritable Class Accessibility 'Allowing using this class by his name only, like using Math
    ...
    End Sub
    Public Shared Sub SetTheDesign(ByVal c As Control.ControlCollection) 'Send controls collection inside form or panel etc... to apply for all of them the same accessibility design
