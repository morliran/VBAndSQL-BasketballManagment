...
#Region "פונקציות של הפורם"
    Private Sub GamesVisionAlgo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        For Count As Integer = 0 To GamesVisionsMyTeamVsOthers.DataGridView1.Rows.Count - 1
            Chart1.Series(0).Points.AddXY(GamesVisionsMyTeamVsOthers.DataGridView1.Item(2, Count).Value, GamesVisionsMyTeamVsOthers.DataGridView1.Item(1, Count).Value)
            Chart1.Series(0).Points(Count).Color = Color.Red
        Next
        SetPropertyHomeChart()
        For Count1 As Integer = 0 To GamesVisionsMyTeamVsOthers.DataGridView2.Rows.Count - 1
            Chart1.Series(1).Points.AddXY(GamesVisionsMyTeamVsOthers.DataGridView2.Item(2, Count1).Value, GamesVisionsMyTeamVsOthers.DataGridView2.Item(1, Count1).Value)
...
#Region "פונקציות עזר"
    Private Sub SetGroupBoxesVsOthers()
        ...
        'קבוצת חוץ'
        Lbl_Anum.Text = GamesVisionsMyTeamVsOthers.DataGridView2.RowCount 'כמה שחקנים בקבוצה
        ...
        'קבוצת בית'
        Lbl_Hnum.Text = GamesVisionsMyTeamVsOthers.DataGridView1.RowCount 'כמה שחקנים בקבוצה
    ...
    Private Sub SetPropertyHomeChart()
        ...
        Chart1.Series(0).Font = New System.Drawing.Font("Microsoft Sans Serif", 9.0F, System.Drawing.FontStyle.Bold)
    ...
    Private Sub SetPropertyAwayChart()
        ...
        Chart1.Series(1).Font = New System.Drawing.Font("Microsoft Sans Serif", 9.0F, System.Drawing.FontStyle.Bold)
