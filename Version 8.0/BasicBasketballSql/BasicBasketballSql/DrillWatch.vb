...
#Region "אופיציות של הפורם ופונקציות עזר"
    ...
    Private Function CheckRequirments() As Boolean
        If CB_PlayerCode.Text.Equals("Choice player code") Or CB_DrillTypesName.Text.Equals("Drill category") Or CB_Drillsname.Text.Equals("Drill options") Or Tb_TriesVal.Text.Equals("How many attempts?") Then
            Return False
        Else
