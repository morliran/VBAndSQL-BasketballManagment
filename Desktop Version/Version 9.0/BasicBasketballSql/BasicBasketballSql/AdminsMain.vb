Public Class AdminsMain
    ...
    Private ArrControls() As Control = New Control() {}, ChekerVal As String, ArrCodes() As String = New String() {}
...
#Region "פונקציות עזר"
    ...
    Private Function CheckVailed(ByVal val As Integer) As Boolean
        If val = 1 Then
            If CB_GameCode.Text.Equals("Game code") Or Tb_HostersCval.Text.Equals("Home code") Or Tb_VisitorsCval.Text.Equals("Away code") Or MTB_TimeVal.MaskCompleted = False Or MTB_GameDate.MaskCompleted = False Then
...
#Region "פונקציה לקבלת קיצור שמות הקבוצות לשימוש בפורומים של ניהול קבוצות או שחקנים"
    Public Sub SetTeamShortCut(ByVal code As String)
        ClassCheckManager.SetManagerName(myHelper.GetColumn("MyName", code, "Admins"))
