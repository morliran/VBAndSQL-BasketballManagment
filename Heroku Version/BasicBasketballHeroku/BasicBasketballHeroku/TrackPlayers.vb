...
#Region "פונקציות על הפורם"
    Private Sub TrackPlayers_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ManagersMain.GetMyError.SetPanelControlsEvents(Panel_Parameters, Me)
        ...
        LastParamHeight = FirstParamHeight * 5 ' 5 -> מס' הפרמטרים האפשריים לחיפוש
...
#End Region
#Region "פונקציות עזר"
    Public Function GetCnt() As Integer
        If Cnt > 5 Then
            Cnt = 5
        ElseIf Cnt < 1 Then
            Cnt = 1
    ...
    Private Function GetData(ByVal ParamNumber As Integer) As DataView
        ...
        End If
        Return ManagersMain.GetDBHelper.GetDataView("Track", t)
    End Function
    ...
    End Sub
    Public Function GetFlagGameType() As Boolean
        Return FlagGameType
    End Function
#End Region
#Region "אירועים של לחיצה על אחד מן הכפתורים שיש בפורם"
    Private Sub Btn_AddParameters_Click(sender As Object, e As EventArgs) Handles Btn_AddParameters.Click
        ...
        Select Case GetCnt()
            Case 2
                ...
                ManagersMain.GetMyError.SetControlsVisibilty(ControlsArr, True)
            Case 3
    ...
    Private Sub Btn_RemoveParameters_Click(sender As Object, e As EventArgs) Handles Btn_RemoveParameters.Click
        ...
        Select Case GetCnt()
            Case 1
                ControlsArr = {Lbl_P2, CB_P2, CB_PSign2, NumUpD_P2, CB_FuncP2}
                ManagersMain.GetMyError.SetControlsVisibilty(ControlsArr, False)
            Case 2
                ControlsArr = {Lbl_P3, CB_P3, CB_PSign3, NumUpD_P3, CB_FuncP3}
                ManagersMain.GetMyError.SetControlsVisibilty(ControlsArr, False)
            Case 3
    ...
    Private Sub Btn_Start_Click(sender As Object, e As EventArgs) Handles Btn_Start.Click
        ...
        Else
            DataGridView1.DataSource = GetData(res)
